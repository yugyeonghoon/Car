...
# 감성 분석 적용
df['sentiment'] = df['reply'].apply(sentiment)
df

# 최종 출력 및 저장
print(df[['car_title', 'trim', 'reply', 'sentiment']])
df[['car_title', 'trim', 'reply', 'sentiment']].to_csv("trim_analyze_test.csv", index=False)
